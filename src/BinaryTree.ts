...
export class BinaryTree<T> {
    ...
    get(value: T) {
        ...
        while (true) {
            ...
            if (value === temp.value) return temp.value;
        }
    }
    ...
    findParentNode(node: Node<T>) {
        ...
        while (true) {
            ...
            if (temp.right && value === temp.right.value) return temp;
            if (temp.left && value === temp.left.value) return temp;
            if (value < temp.value) {
                temp = temp.left;
                continue;
            }
    ...
    _inorderInternal(currentNode: Node<T> | null) {
    ...
    deleteNode(currentNode:Node<T>, itemValue:T) {
